...
seo:
  title: Debounced Search - VueAirport
  description: Implement search-as-you-type functionality with VueAirport's debounce plugin. Learn event batching, flush/cancel operations, and maxWait configuration.
---
...
const mockDatabase = [
  ...
  { id: 'vue-3', title: 'VueAirport Library', description: 'Generic check-in system for Vue', category: 'Vue' },
...
```vue
<script setup lang="ts">
import { checkInToDesk } from '#vue-airport/composables/desk-child';
import { type SearchResult, SEARCH_DESK_KEY } from '.';
